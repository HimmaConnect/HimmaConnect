...
$id = isset($_GET['id_anggota']) ? (int)$_GET['id_anggota'] : 0;
if ($id <= 0) {
...
<div class="bg-white shadow-sm border-b py-3 px-4 fixed top-0 left-0 right-0 z-50">
    <h1 class="text-lg font-bold text-blue-700">Edit Anggota</h1>
</div>
...
<div class="pt-20 px-4 pb-8">
    ...
    <div class="bg-white p-5 shadow rounded-xl border">
        ...
        <h2 class="text-xl font-bold mb-5 text-gray-800">Edit Anggota</h2>
        ...
        <form method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="text-center">
                <img 
                    src="../uploads/anggota/<?= htmlspecialchars($foto_lama) ?>"
                    onerror="this.src='../uploads/anggota/default.jpg'"
                    class="w-28 h-28 rounded-full object-cover shadow mx-auto mb-3"
                    alt="Foto anggota"
                >
